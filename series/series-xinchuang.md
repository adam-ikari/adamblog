---
title: 信创专题系列
description: 信息技术应用创新（信创）全栈调查报告：总览、国产CPU、整机PC、操作系统、数据库、中间件、办公应用、安全
date: 2026-07-02
category: 信创
tags: [信创, 国产化, 自主可控, 系列]
recommend: false
...
信创（信息技术应用创新）是中国 IT 产业自主可控的主线。本系列按信创全栈逐层调查——从总览到国产 CPU、整机、操作系统、数据库、中间件、办公应用、安全，每篇为调查报告，事实联网核验，讲清各层的来历、格局与真实进度。

<SeriesCardList :articles="[
  { title: '信创总览：从去 IOE 到自主可控', desc: '是什么、四大领域、发展历程、政策脉络、市场规模', link: '/posts/信创总览-从去IOE到自主可控', order: 1 },
  { title: '国产 CPU 详解：六条路线', desc: '龙芯/鲲鹏/飞腾/兆芯/海光/申威 架构与自主程度对比', link: '/posts/国产CPU详解-六条路线', order: 2 },
